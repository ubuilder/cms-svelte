...
{#each pages as pageItem}
	...
	<div
		...
		<div class="flex items-center gap-2">
			...
			<Icon name="pencil" class="page-edit-icon text-gray-400 hover:text-gray-600 cursor-pointer" mb=1 ms="auto" on:click!stopPropagation={() => openPageSettings(pageItem)} />
		</div>
	</div>
{:else}
